...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const scriptUrlGroup = document.getElementById('script-url-group');
        ...
        const providerConfig = {
            ...
            liveagent: {
                label: 'Button ID',
                placeholder: 'sr6qt5vg',
                help: 'Find the Button ID in your LiveAgent dashboard under Settings > Chat > Chat buttons.',
        ...
        function updateForm() {
            ...
            if (provider && provider !== 'disabled') {
                ...
                scriptUrlGroup.style.display = provider === 'liveagent' ? 'block' : 'none';

            } else {
                widgetIdGroup.style.display = 'none';
                baseUrlGroup.style.display = 'none';
                scriptUrlGroup.style.display = 'none';
            }
        }
